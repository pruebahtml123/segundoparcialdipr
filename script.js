document.addEventListener('DOMContentLoaded', () => {
    // Banco de preguntas AHORA CON PROPIEDAD 'topic'
    const questionBank = [
        ...
        { topic: "Responsabilidad Civil", question: "¿Qué ley se aplica como regla general en un caso de responsabilidad civil internacional (Art. 2657 CCCN)?", answer: "Como regla general, se aplica el derecho del país donde se produce el daño (*lex loci damni*)." },
    ...
    function populateTopicSelection() {
        topicSelectionContainer.innerHTML = ''; // Limpiar por si se reinicia
    ...
    function setupAndStartQuiz() {
        ...
        masterQuestionPool = questionBank.filter(q => selectedTopics.includes(q.topic));
